...
I later got introduced to other high-level languages as C/C++. This lead me to discover the world of Algorithmic Programming, I programmed for about a year, exclusively in C++11. My first choice for solving algorithmic problems will always be C++.

My interest in Open Source is rather recent. I started contributing regularly from December'15. I liked hanging around on the IRC, trying to get to know SunPy's mission, better. I'm fascinated by how Software Engineering forms the very backbone of SunPy and how proficient and better the SunPy developers are at programming than me, when software engineering isn't even their job and I on the other hand am majoring in it, I have lots to learn! I have gained a ton of invaluable insight by talking to SunPy developers, from the developer reviews and from learning, rather painfully, version control and now have a better understanding of how crucial Python is to the Scientific community. Interning with SunPy would allow me to become wiser and step into the real world of Software development. This project would also help me strengthen my programming abilities in Python.
