...
| ----------- | ------------------- |
|     May 6 - May 27        |  <ul><li>Read the documentation again make myself familiar with all functionalities already present.</li><li>Read all the research papers to get myself familiar with the algorithms which are to be implemented.</li><li>Read and understand all the IDL codes. Read IDL documentation.</li><li>Develop a pseudocode for the primary tasks.</li><li> Discuss with mentors about the potential discrepancies between the implementation already present and the IDL codes like in the case of MGN.</li><li>Learn about how to write image tests, which will be useful later.</li></ul>  |
