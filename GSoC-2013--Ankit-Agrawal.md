...
* Reading papers mentioned in the reference and discussing the possible ideas with the mentors to finalize the best possible algorithm for a particular task.
